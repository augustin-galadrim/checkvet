from ._anvil_designer import EN_AudioManagerBackupTemplate
from anvil import *
import anvil.server
...
class EN_AudioManagerBackup(EN_AudioManagerBackupTemplate):
  def __init__(
    self,
    clicked_value=None,
    template_name=None,
  ...
  def process_recording(self, audio_blob, **event_args):
    ...
    if not selected_template or selected_template.startswith(("Select", "Sélection")):
