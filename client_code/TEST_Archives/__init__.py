from ._anvil_designer import TEST_ArchivesTemplate
from anvil import *
import anvil.server
import anvil.users
...
class TEST_Archives(TEST_ArchivesTemplate):
  ...
  def open_audio_manager_form(self, report, **event_args):
    ...
    try:
      ...
      open_form("TEST_AudioManagerEdit", report=safe_report)
  ...
  def open_create_form(self, **event_args):
    ...
    open_form("TEST_AudioManagerUltimate3")
        ...
        transformed_results.append(
          {
            ...
            "name": safe_value(
              rep, "name", ""
            ),  # Utilisation de 'name' pour le patient
