from ._anvil_designer import TEST_ArchivesSecretariatTemplate
from anvil import *
import anvil.server
import anvil.users
...
class TEST_ArchivesSecretariat(TEST_ArchivesSecretariatTemplate):
  ...
  def open_audio_manager_form(self, report, **event_args):
    try:
      ...
      open_form("TEST_AudioManagerEditSecretariat", report=safe_report)
    except Exception as e:
