from ._anvil_designer import TEST_AudioManagerEditSecretariatTemplate
from anvil import *
...
class TEST_AudioManagerEditSecretariat(TEST_AudioManagerEditSecretariatTemplate):
  def __init__(
  ...
  def build_report_pdf_relay(self, placeholders, images):
    print(
      "build_report_pdf_relay appelé en mode édition avec placeholders :",
      placeholders,
      "et images :",
      images,
    )
