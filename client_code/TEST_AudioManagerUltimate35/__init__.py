from ._anvil_designer import TEST_AudioManagerUltimate35Template
from anvil import *
import anvil.server
...
class TEST_AudioManagerUltimate35(TEST_AudioManagerUltimate35Template):
  def __init__(
    self,
    clicked_value=None,
    template_name=None,
  ...
  def process_recording(self, audio_blob, **event_args):
    ...
    if not selected_template_name or selected_template_name.startswith("Sélection"):
    ...
    prompt = call_with_retry(
      "pick_template", selected_template_name, prompt_col
