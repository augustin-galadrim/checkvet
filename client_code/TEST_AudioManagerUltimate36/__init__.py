from ._anvil_designer import TEST_AudioManagerUltimate36Template
from anvil import *
import anvil.server
...
class TEST_AudioManagerUltimate36(TEST_AudioManagerUltimate36Template):
  def __init__(
    self,
    clicked_value=None,
    template_name=None,
  ...
  def process_consolidated_audio_toolbar(self, **event_args):
    if not self.audio_chunks or "" in self.audio_chunks:
      return {"error": "Tous les morceaux audio n'ont pas été reçus."}
    ...
    return self.process_toolbar_recording(media)
