...
def update_template_visibility(template_name, is_visible):
  """
  Updates the visibility of a template for the current user.
  """
  ...
  if row:
    row["display_template"] = is_visible
    print(f"Template '{template_name}' visibility set to {is_visible}")
  else:
